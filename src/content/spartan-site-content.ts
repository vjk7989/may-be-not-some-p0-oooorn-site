...
export const spartanSiteContent: SpartanSiteContent = {
  company: {
    name: "Spartan",
    description: "Custom neural agents, LLMs, and automation for modern enterprises.",
  ...
  product: {
    name: "Digital Brain",
    eyebrow: "Digital Brain v4.0.2",
    title: "Own Your Private Neural Engine",
    summary: "Deploy a secure, pre-trained AI brain that masters your enterprise data in milliseconds.",
    mediaId: "neural-core",
    capabilities: [
  ...
  projects: [
    {
      ...
      summary: "Revolutionizing patient care through predictive analytics and seamless AI-driven diagnostic integration tools.",
    ...
    },
    {
      ...
      category: "HEALTHCARE",
      summary: "We automated Aetna’s member data management through a secure, intelligent healthcare ecosystem.",
    ...
    },
    {
      ...
      category: "HEALTHCARE",
      summary: "We deployed a custom LLM to automate Anthem’s provider relations and care network operations.",
    ...
    },
    {
      ...
      title: "CVS Smart Supply Chain Hub",
      category: "RETAIL & LOGISTICS",
      summary: "We built a predictive inventory engine for CVS to synchronize demand, supply, and fulfillment.",
    ...
    },
    {
      ...
      title: "United AI Security Protocol",
      category: "CYBERSECURITY",
      summary: "We developed an AI-driven threat detection system for a resilient global security perimeter.",
  ...
  capabilities: [
    { index: "001", title: "Autonomous Agent Architecture Labs", description: "Architecting robust server environments and local LLM integrations to ensure data remains secure and local." },
    { index: "002", title: "Autonomous Agentic Workflows", description: "Designing intelligent workflows that reason, coordinate tools, and complete multi-step work at enterprise scale." },
    { index: "003", title: "Data Pipelines & RAG Systems", description: "Connecting trusted enterprise context to accurate retrieval and production-ready neural systems." },
  ],
  process: [
    { index: "01", title: "Comprehensive Strategic Audit", description: "We perform a deep-layer analysis of your current technical stack and fragmented data silos to identify high-impact AI opportunities that align with your core business objectives and ROI targets." },
    { index: "02", title: "Custom Architecture Design", description: "We map the model, data, interface, and infrastructure required for your custom neural system." },
    { index: "03", title: "Rapid Prototype Development", description: "We build and test the highest-value workflows in focused production sprints." },
    { index: "04", title: "Enterprise Scale Deployment", description: "We harden, monitor, and scale your system across the environments where it creates value." },
  ],
  disciplines: [
  ...
  faqs: [
    { question: "How do you ensure our data remains secure?", answer: "We utilize SOC2-compliant local vector databases and on-premise LLM hosting to ensure your proprietary data never leaves your infrastructure." },
    { question: "What is the typical deployment timeline?", answer: "Most custom deployments move from strategic audit to production-ready infrastructure in a focused, iterative delivery cycle." },
    { question: "Can we integrate with our existing CRM?", answer: "Yes. We design integrations around your current stack, data permissions, and operational workflows." },
    { question: "Do you provide model fine-tuning?", answer: "Yes. Fine-tuning, retrieval systems, evaluation, and model routing are available where the use case requires them." },
    { question: "How do you calculate ROI for automation?", answer: "We baseline time, cost, quality, and throughput before deployment, then measure the same signals after launch." },
    { question: "Do we own the custom code you build?", answer: "Yes. Custom architecture and implementation are transferred according to the terms of your engagement." },
    { question: "What models do you specialize in?", answer: "We work across leading open and proprietary models, choosing the stack that best fits your security, latency, and quality requirements." },
  ],
  media,
};
